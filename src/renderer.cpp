...
auto Renderer::draw_line(int x0, int y0, int x1, int y1, uint32_t color) -> void {
    int delta_x = (x1 - x0);
    int delta_y = (y1 - y0);
...
auto Renderer::draw_triangle(int x0, int y0, int x1, int y1, int x2, int y2, uint32_t color)
    -> void {
...
auto Renderer::draw_filled_triangle(int x0, int y0, int x1, int y1, int x2, int y2, uint32_t color)
    -> void {
